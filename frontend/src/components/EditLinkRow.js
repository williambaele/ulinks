...
const EditLinkRow = ({ link, user, toggleIsEdit }) => {
  ...
  return (
    <div className="relative h-20 rounded-2xl ">
      <div className="absolute top-0 right-0 flex items-center justify-center w-32 h-8 gap-4 bg-red-200 shadow-sm rounded-tr-2xl rounded-bl-2xl">
        <div>
          {active === false ? (
            <svg
      ...
      <div className="flex items-center h-full px-4 bg-purple-200 gap-x-4 rounded-2xl">
        <form
